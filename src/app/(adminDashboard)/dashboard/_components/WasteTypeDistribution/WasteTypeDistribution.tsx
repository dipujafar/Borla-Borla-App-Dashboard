...
const data = [
  { name: "Organic", value: 42, color: "#10B981" }, // Emerald 500
  { name: "Metal", value: 18, color: "#92400E", labelValue: "32%" }, // Bronze/Brown
  { name: "Plastic", value: 15, color: "#A855F7", labelValue: "20%" }, // Purple 500
  { name: "General", value: 15, color: "#F59E0B", labelValue: "20%" }, // Amber 500
  { name: "Paper", value: 10, color: "#3B82F6", labelValue: "20%" }, // Blue 500
]
